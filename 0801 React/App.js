...
function App() {
  ...
  const [titleColor, setTitleColor] = useState(Array(title.length).fill("black"));

  return (
    <div className="App">
      <div className="black-nav" style={{ background: "blue" }}> {/*배경색 다른색으로 수정*/}
        <div>
          ...
          <div className="list">
            <h4
              onClick={() => {
                ...
                let colors = Array(title.length).fill("black");
                colors[i] = "red";
